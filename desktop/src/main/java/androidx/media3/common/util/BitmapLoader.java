...
/** Loads images. (Verbatim port of media3 1.9.2.) */
@UnstableApi
public interface BitmapLoader {
   ...
   * bitmap information.
   *
   * <p>By default, the method will try to decode an image from {@link MediaMetadata#artworkData}
   * if it is present. Otherwise, the method will try to load an image from {@link
