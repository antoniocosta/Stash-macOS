 ...
 *
 * <p>Desktop port of AndroidX core {@code ColorUtils} (androidx-main): the int-color API is
 * verbatim; the API 26 {@code android.graphics.Color}-object overload of
 * {@code compositeColors} and the M3HCT methods (backed by {@code CamColor}) are omitted.
 */
